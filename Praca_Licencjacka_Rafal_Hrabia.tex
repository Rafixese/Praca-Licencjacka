...
\begin{lstlisting}[language=Python, caption={Trening modelu}, label={lst:modeltrain}]
	# %% Fit
...
\begin{lstlisting}[language=Python, caption={Wizualizacja wyników}, label={lst:modelplt}]
	# %% Plot
